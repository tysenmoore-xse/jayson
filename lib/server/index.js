 ...
 */
Server.prototype.call = function(request, originalCallback, originalReq) {
  var self = this;
 ...
 * @return {Method}
 */
Server.prototype._resolveRouter = function(method, params, originalRequest) {
  ...
  var resolved = router.call(this, method, params, originalRequest);
